...
app.use(express.urlencoded({extended: true, limit: "16kb"})) //URLS generally convert special characters like it coverts space--> %20 and to make express understand we use this urlencoded
